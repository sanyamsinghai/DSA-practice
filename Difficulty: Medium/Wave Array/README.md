<h2><a href="https://www.geeksforgeeks.org/problems/wave-array-1587115621/1">Wave Array</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Given an <strong>s</strong><strong>orted</strong> array arr[] of integers. Sort the array into a wave-like array (In Place). In other words,<strong> </strong>arrange the elements into a sequence such that : arr[0] ≥ arr[1] ≤ arr[2] ≥ arr[3] ≤ arr[4] ≥ ... and so on. If there are multiple solutions, find the lexicographically smallest one.</span></p>
